/*!
 * chartjs-plugin-gradient v0.1.1
...
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['chartjs-plugin-gradient'] = factory());
  ...
  for (const value of Object.keys(colors)) {
    ...
    if (isFinite(pixel) && isFinite(stop)) {
      gradient.addColorStop(
        ...
        index_esm(colors[value]).rgbString()
      );
    }
  }
}
